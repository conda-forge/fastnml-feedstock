...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fastnml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15188&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fastnml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fastnml` can be installed with:

```
conda install fastnml
```

It is possible to list all of the versions of `fastnml` available on your platform with:
